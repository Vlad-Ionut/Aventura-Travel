...
_Generated: 2026-05-18T15:56:38.574Z_
...
Workspace `mcp.json` _(folder: proiect6)_

- **c:\Users\salga\Desktop\proiect6\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\salga\.claude.json** — _File exists — no servers defined_
